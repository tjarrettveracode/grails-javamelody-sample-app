	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<li class="fieldcontain">
					<span id="pubDate-label" class="property-label"><g:message code="book.pubDate.label" default="Pub Date" /></span>

						<span class="property-value" aria-labelledby="pubDate-label"><g:formatDate date="${bookInstance?.pubDate}" /></span>
			...
			<g:form>
                ...
                <script>
var isbn = '${org.owasp.encoder.Encode.forJavaScript(bookInstance.isbn)}';
                </script>
	</body>
</html>
